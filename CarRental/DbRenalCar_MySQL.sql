-- MySQL version of DbRenalCar database
-- Converted from SQL Server to MySQL

CREATE DATABASE IF NOT EXISTS DbRenalCar CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE Account(
	...
	FullName VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	...
	RoleId INT NULL,
	LastLogin CHAR(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
...
CREATE TABLE Blog(
	...
	Title VARCHAR(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	Alias VARCHAR(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	CategoryId INT NULL,
	Description VARCHAR(4000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	Detail LONGTEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	Image VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	SeoTitle VARCHAR(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	SeoDescription VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	SeoKeywords VARCHAR(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	CreatedDate DATETIME NULL,
	CreatedBy VARCHAR(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	ModifiedDate DATETIME NULL,
	ModifiedBy VARCHAR(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	AccountId INT NULL,
...
CREATE TABLE CarImages(
	...
	Image1 LONGTEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	CarID INT NULL,
	Image2 LONGTEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	Image3 LONGTEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	Image4 LONGTEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	PRIMARY KEY (ImageID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Table: CarRentalOrders
CREATE TABLE CarRentalOrders(
	...
	Notes VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	PRIMARY KEY (OrderID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Table: CarReviews
CREATE TABLE CarReviews(
	CarReviewID INT AUTO_INCREMENT NOT NULL,
	Name VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	Phone VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	Email VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	CreatedDate DATETIME NULL,
...
CREATE TABLE Cars(
	...
	CarName VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	Seat INT NULL,
	LicensePlate VARCHAR(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	Price DECIMAL(18, 2) NULL,
	Color VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	Model INT NULL,
	Rate DOUBLE NULL,
	CarBrand VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	Image LONGTEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	SalePrice DECIMAL(18, 2) NULL,
	Alias VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	IsSale TINYINT(1) NOT NULL,
	IsActive TINYINT(1) NOT NULL,
	Details LONGTEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	Descriptions LONGTEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	TypeID INT NULL,
	PRIMARY KEY (CarID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE CarTypes(
	...
	CarTypeName VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	Seats INT NULL,
	Manufacturer VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	Image LONGTEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	PRIMARY KEY (TypeID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE Contact(
	...
	Name VARCHAR(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	Phone VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
...
CREATE TABLE Contract(
	...
	GeneralTerms LONGTEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	SpecificTerms LONGTEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
...
CREATE TABLE ContractDetails(
	ContractDetailID INT AUTO_INCREMENT NOT NULL,
...
-- Table: ContractSettlementDetails
CREATE TABLE ContractSettlementDetails(
	SettlementDetailID INT AUTO_INCREMENT NOT NULL,
...
CREATE TABLE ContractSettlements(
	SettlementID INT AUTO_INCREMENT NOT NULL,
	ContractID INT NOT NULL,
	Date DATE NULL,
...
CREATE TABLE Customers(
	...
	LicenseNumber VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	LicenseImage LONGTEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	IDCard VARCHAR(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	PhoneNumber VARCHAR(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	AccountNumber VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	Bank VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	CompanyName VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
	Avartar VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
...
CREATE TABLE Menu(
	...
	Alias VARCHAR(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
...
CREATE TABLE OrderStatus(
	...
	StatusDescription VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
...
CREATE TABLE Role(
	RoleId INT NOT NULL,
	RoleName VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
...
INSERT INTO Cars (CarID, CarName, Seat, LicensePlate, Price, Color, Model, Rate, CarBrand, Image, SalePrice, Alias, IsSale, IsActive, Details, Descriptions, TypeID) VALUES 
...
ALTER TABLE CarRentalOrders ADD CONSTRAINT FK_CarRentalOrders_Customer FOREIGN KEY (CustomerID) REFERENCES Customers (CustomerID);

ALTER TABLE CarRentalOrders ADD CONSTRAINT FK_CarRentalOrders_Status FOREIGN KEY (StatusID) REFERENCES OrderStatus (StatusID);

ALTER TABLE CarReviews ADD CONSTRAINT FK_CarReviews_Cars FOREIGN KEY (CarID) REFERENCES Cars (CarID);

ALTER TABLE Cars ADD CONSTRAINT FK_Cars_CarTypes FOREIGN KEY (TypeID) REFERENCES CarTypes (TypeID);

ALTER TABLE Contract ADD CONSTRAINT FK_Contract_Customer FOREIGN KEY (CustomerID) REFERENCES Customers (CustomerID);

ALTER TABLE ContractDetails ADD CONSTRAINT FK_ContractDetails_CarType FOREIGN KEY (CarTypeID) REFERENCES CarTypes (TypeID);

ALTER TABLE ContractDetails ADD CONSTRAINT FK_ContractDetails_Contract FOREIGN KEY (ContractID) REFERENCES Contract (ContractID);

ALTER TABLE ContractSettlementDetails ADD CONSTRAINT FK_ContractSettlementDetails_Settlement FOREIGN KEY (SettlementID) REFERENCES ContractSettlements (SettlementID);

ALTER TABLE ContractSettlements ADD CONSTRAINT FK_ContractSettlements_Contract FOREIGN KEY (ContractID) REFERENCES Contract (ContractID);

ALTER TABLE NewsComment ADD CONSTRAINT FK_NewsComment_News FOREIGN KEY (NewsId) REFERENCES News (NewsId);

ALTER TABLE OrderDetails ADD CONSTRAINT FK_OrderDetails_Order FOREIGN KEY (OrderID) REFERENCES CarRentalOrders (OrderID);
